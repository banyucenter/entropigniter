                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10">Uniform Coding Entropy</h5>
                                    </div>
                                    <ul class="breadcrumb">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
												...
												<div class="form-group">
                                                            ...
                                                            <br>
                                                            <button type="button" class="btn btn-primary" onclick="convert()">Encode</button>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                            ...
                                                            <br>
                                                            <button type="button" class="btn btn-primary" onclick="bintotext()">Decode</button>
                                                </div>
    ...
    <script src="<?php echo base_url().'assets/template/';?>assets/js/uniform.js"></script>
